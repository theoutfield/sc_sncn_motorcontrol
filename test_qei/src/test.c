...
{
	int position;
	printf("enter max position\n");
	scanf("%d", &position);
	d->max_position = position;
	return 1;
}
...
{
	int position;
	printf("enter min position\n");
	scanf("%d", &position);
	d->min_position = position;
	return 1;
}

int input_pos(in_data *d)
{
	int position, exit_mode;
...
{
	int activate;
	printf("Position control Enable 1 / Disable 0\n");
	scanf("%d", &activate);
	d->activate = activate;
	return 1;
}
...
{
	int activate;
	printf("Velocity control Enable 1 / Disable 0\n");
	scanf("%d", &activate);
	d->activate = activate;
	return 1;
}
