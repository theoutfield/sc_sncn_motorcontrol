...
void set_velocity_ctrl_HallConfigam(HallConfig & hall_config, chanend c_velocity_ctrl)
{
    VELOCITY_CTRL_WRITE(VCTRL_CMD_SET_HALL);
    VELOCITY_CTRL_WRITE(hall_config.pole_pairs);
    VELOCITY_CTRL_WRITE(hall_config.max_ticks);
    VELOCITY_CTRL_WRITE(hall_config.max_ticks_per_turn);
}
