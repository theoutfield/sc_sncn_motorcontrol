        ...
        case 'a':
                ...
                default://find motor commutation offset automatically
                    ...
                    if (general_system_evaluation(i_motion_control) == 0)
                    {
                        ...
                        else if(motorcontrol_config.commutation_angle_offset == -2)
                        {
                            printf(">>  ERROR: proper value of pole-pairs is %d \n", motorcontrol_config.pole_pairs);
                            printf(">>         please correct this value in you configuration file\n");
                        }
                        else
                        {
