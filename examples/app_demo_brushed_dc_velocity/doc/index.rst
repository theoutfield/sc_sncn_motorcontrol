...
.. cssclass:: github
  ...
  `See Application on Public Repository <https://github.com/synapticon/sc_sncn_motorcontrol/tree/develop/examples/app_demo_brushed_dc_velocity/>`_
...
5. Open the **main.xc** within  the **app_demo_brushed_dc_velocity**. Include the **board-support file according to your device** (LINK TO BOARD SUPPORT MODULE?). Also set the appropiate target in your Makefile. (LINK HOW TO SET YOUR RIGHT TARGET IN YOUR MAKEFILE)
...
6. Set the configuration for Motor Control, Encoder, and Velocity Control Services. Also for your Velocity Profiler.  (LINK TO HOW TO CONFIGURE) 
