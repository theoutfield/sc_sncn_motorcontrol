...

{
    ...
    while(1)
    {
        ...
        case i_tuning_step[int i].set_ctrl_parameters(MotionControlConfig in_motion_ctrl_config):
                motion_ctrl_config = in_motion_ctrl_config;
        break;

        case i_tuning_step[int i].get_ctrl_parameters() -> MotionControlConfig out_motion_ctrl_config:
                out_motion_ctrl_config = motion_ctrl_config;
        break;
