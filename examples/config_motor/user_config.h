...
// RESOLUTION (TICKS PER TURN) OF YOUR COMMUTATION SENSOR
#define COMMUTATION_SENSOR_RESOLUTION               REM_16MT_SENSOR_RESOLUTION

// VELOCITY COMPUTE PERIOD (ALSO POLLING RATE) OF YOUR COMMUTATION SENSOR (microseconds)
#define COMMUTATION_SENSOR_VELOCITY_COMPUTE_PERIOD  REM_16MT_SENSOR_VELOCITY_COMPUTE_PERIOD

// POLARITY OF YOUR COMMUTATION SENSOR [1,-1]
#define COMMUTATION_SENSOR_POLARITY                 NORMAL_POLARITY

// SENSOR USED FOR CONTROL FEEDBACK [HALL_SENSOR, QEI_SENSOR, BISS_SENSOR, REM_14_SENSOR, REM_16MT_SENSOR]
#define MOTOR_FEEDBACK_SENSOR                       MOTOR_COMMUTATION_SENSOR

// RESOLUTION (TICKS PER TURN) OF YOUR FEEDBACK SENSOR
#define FEEDBACK_SENSOR_RESOLUTION                  COMMUTATION_SENSOR_RESOLUTION

// VELOCITY COMPUTE PERIOD (ALSO POLLING RATE) OF YOUR FEEDBACK SENSOR (microseconds)
#define FEEDBACK_SENSOR_VELOCITY_COMPUTE_PERIOD     COMMUTATION_SENSOR_VELOCITY_COMPUTE_PERIOD

// POLARITY OF YOUR FEEDBACK SENSOR [1,-1]
#define FEEDBACK_SENSOR_POLARITY                    COMMUTATION_SENSOR_POLARITY
