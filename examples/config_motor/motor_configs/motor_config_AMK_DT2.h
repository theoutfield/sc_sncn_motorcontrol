...
#define PERCENT_TORQUE_CONSTANT 18      //motor torque constant multiplied by 100
#define RATED_CURRENT           320    //rated phase current [milli-Amp-RMS]
#define MAXIMUM_TORQUE          1250    //maximum value of torque which can be produced by motor [milli-Nm]
