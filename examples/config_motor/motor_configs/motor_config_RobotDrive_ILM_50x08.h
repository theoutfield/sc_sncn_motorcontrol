...
#define MOTOR_MAXIMUM_TORQUE          900     //maximum value of torque which can be produced by motor [milli-Nm]
#define MOTOR_RATED_TORQUE            270     // rated motor torque [milli-Nm]
...
#define MOTOR_PHASE_RESISTANCE  552000  // motor phase resistance [micro-ohm]
#define MOTOR_PHASE_INDUCTANCE  720     // motor phase inductance [micro-Henry]
