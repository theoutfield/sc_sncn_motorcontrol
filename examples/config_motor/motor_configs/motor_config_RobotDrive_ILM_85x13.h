...
#define MOTOR_MAXIMUM_TORQUE          4500    //maximum value of torque which can be produced by motor [milli-Nm]
#define MOTOR_RATED_TORQUE            1430    // rated motor torque [milli-Nm]
...
#define MOTOR_PHASE_RESISTANCE  210000  // motor phase resistance [micro-ohm]
#define MOTOR_PHASE_INDUCTANCE  470     // motor phase inductance [micro-Henry]
