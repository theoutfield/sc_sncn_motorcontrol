...
#define MOTOR_TORQUE_CONSTANT   150000  //Torque constant [micro-Nm/Amp-RMS]
#define MOTOR_RATED_CURRENT           8000    //rated phase current [milli-Amp-RMS]
#define MOTOR_MAXIMUM_TORQUE          2500    //maximum value of torque which can be produced by motor [milli-Nm]
#define MOTOR_RATED_TORQUE            1250    //rated motor torque [milli-Nm].
