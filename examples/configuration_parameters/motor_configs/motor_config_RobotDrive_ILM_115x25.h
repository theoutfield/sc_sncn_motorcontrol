...
#define MOTOR_POLE_PAIRS        15      //number of motor pole-pairs
...
#define MOTOR_MAXIMUM_TORQUE          12200   //maximum value of torque which can be produced by motor [milli-Nm]
#define MOTOR_RATED_TORQUE            5400    // rated motor torque [milli-Nm]
...
#define MOTOR_PHASE_RESISTANCE  125000  // motor phase resistance [micro-ohm]
#define MOTOR_PHASE_INDUCTANCE  525     // motor phase inductance [micro-Henry]
