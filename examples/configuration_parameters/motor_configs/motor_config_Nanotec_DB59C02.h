...
#define MOTOR_TORQUE_CONSTANT   44000  //Torque constant [micro-Nm/Amp-RMS]
#define MOTOR_RATED_CURRENT           13600    //rated phase current [milli-Amp-RMS]
#define MOTOR_MAXIMUM_TORQUE          1800    //maximum value of torque which can be produced by motor [milli-Nm]
#define MOTOR_RATED_TORQUE            600     // rated motor torque [milli-Nm]
#define MOTOR_MAX_SPEED               3500    // please update from the motor datasheet [rpm]
...
#define MOTOR_PHASE_RESISTANCE  135000  // motor phase resistance [micro-ohm]
