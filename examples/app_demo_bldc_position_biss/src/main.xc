...
void position_profile_test(interface PositionControlInterface client i_position_control)
{
    ...
    target_position = actual_position + target_position;
    printf("actual position %d, target position%d\n", actual_position, target_position);
...
BISSPorts biss_ports = {QEI_PORT, SOMANET_IFM_GPIO_D0, IFM_TILE_CLOCK_1};
    ...
    par
    {
        ...
        /* XScope monitoring */
        {
            ...
            while(1)
            {
                ...
                delay_milliseconds(10); /* 10 ms wait */
            }
        }
...
//            i_biss[1].reset_biss_position(0);
            /* Control Loop */
