 ...
 * @brief Motor Control config file for Nanotech DB42-S03, 26 Watt with Hall sensors and Encoder (Nanotec WEDL5541-B14)
...
#define ENCODER_RESOLUTION          1000               // 4 x Max count of Incremental Encoder (4X decoding - quadrature mode)
