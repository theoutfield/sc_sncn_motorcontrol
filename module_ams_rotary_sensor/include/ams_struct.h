...
#ifndef AMS_STRUCT_H_
#define AMS_STRUCT_H_
...
#define AMS_MAX_TICKS           0x7fffffff
#define AMS_HYSTERESIS          1
#define AMS_FACTORY_SETTINGS    1
#define AMS_UVW_ABI             0
#define AMS_DYN_ANGLE_COMP      0
#define AMS_DATA_SELECT         0
#define AMS_ABI_RESOLUTION      0
