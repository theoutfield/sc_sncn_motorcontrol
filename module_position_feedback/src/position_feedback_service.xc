                   ...
                   server interface PositionFeedbackInterface i_position_feedback[3])
{
    ...
    case REM_14_SENSOR:
        ...
        break;
    case REM_10_SENSOR:
        as5050a_service(*spi_ports, position_feedback_config, i_shared_memory, i_position_feedback);
        break;
    case HALL_SENSOR:
...
void check_ports(HallPorts * hall_ports, QEIPorts * qei_ports, SPIPorts * spi_ports, PositionFeedbackConfig &position_feedback_config)
{
    ...
    if ( (position_feedback_config.sensor_type == HALL_SENSOR && hall_ports == null) ||
         ...
         ((position_feedback_config.sensor_type == REM_16MT_SENSOR || position_feedback_config.sensor_type == REM_14_SENSOR || position_feedback_config.sensor_type == REM_10_SENSOR) && spi_ports == null) ) {
                               ...
                               server interface PositionFeedbackInterface (&?i_position_feedback_2)[3])
{
    ...
    while(1) {
        ...
        if (!isnull(position_feedback_config_1)) {
            ...
            if (position_feedback_config_1.sensor_type == BISS_SENSOR) {
                ...
                if (isnull(position_feedback_config_2)) {
                    ...
                    if (position_feedback_config_2.sensor_type != REM_16MT_SENSOR && position_feedback_config_2.sensor_type != REM_14_SENSOR && position_feedback_config_2.sensor_type != REM_10_SENSOR) {
                        set_clock_biss(qei_ports_1, spi_ports_1, position_feedback_config_1);
                    }
                }
            }
        ...
        if (!isnull(position_feedback_config_2) && !isnull(position_feedback_config_1)) {
            ...
            if (spi_ports_1 != null && position_feedback_config_1.sensor_type != REM_16MT_SENSOR &&  position_feedback_config_1.sensor_type != REM_14_SENSOR &&  position_feedback_config_1.sensor_type != REM_10_SENSOR)
