...
[[combinable]]
 void contelec_service(SPIPorts &spi_ports, CONTELECConfig & contelec_config, client interface shared_memory_interface ?i_shared_memory, interface CONTELECInterface server i_contelec[5])
{
