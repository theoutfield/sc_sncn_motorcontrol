...
interface shared_memory_interface
{
    ...
    */
    {unsigned int, int, int, int, int} get_angle_velocity_position_hall();
    ...
    */
    void write_angle_velocity_position_hall(unsigned int in_angle, int in_velocity, int in_count, int in_hall_state, int in_hall_low_speed);
   /**
    * @brief Write multi-turn electrical angle and current velocity and position to shared memory.
    *
    * @param  Current velocity.
