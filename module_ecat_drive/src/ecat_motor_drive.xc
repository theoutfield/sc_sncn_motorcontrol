                ...
                case 0x000f: //switch on cyclic
                    ...
                    if (op_mode == HM) {
                        if (ack == 0 ) {
                            ...
                            if (reset_counter == 0) {
                                ack = 1; /* FIXME: given the else-if-branch we're in, ack will always be 1 - or should it be set to 0 here? */
                                if (i < steps) {
                    ...
                    if (op_mode == CSV) {
                        ...
                        if (ack == 1) {
                            ...
                            if (prev_torque != target_torque) {
                                ack = 0;
                                steps = init_linear_profile(target_torque,
                                                            actual_torque,
                        ...
                        if (ack == 1) {
                            ...
                            if (prev_velocity != target_velocity) {
                                ack = 0;
                                steps = init_velocity_profile(target_velocity,
                                                              actual_velocity,
