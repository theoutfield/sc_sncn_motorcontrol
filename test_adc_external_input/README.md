test_adc_external_input.xc illustrates usage of \ref module_adc to get external analog sensor input values. By default all analog inputs are configured as differential only.
