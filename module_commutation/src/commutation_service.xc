...
<<<<<<< HEAD:module_commutation/src/commutation_service.xc
...
>>>>>>> Resolve conflicts ocured cause Agus removed the hall_par argument from run_hall and other functions:module_commutation/src/commutation_server.xc
