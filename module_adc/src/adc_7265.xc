...
#pragma ordered
        ...
        case iADC[int i].get_all_measurements(int motor_type) -> {
            ...
            phaseB_out = current_sensor_config.sign_phase_b * (out_a - 2048)-36-8;
            phaseC_out = current_sensor_config.sign_phase_c * (out_b - 2048)-36-8;
//            if(current_sensor_config.sign_phase_a != 0 && motor_type==BLDC_MOTOR)//if phase a is measured instead of phase C
